...
const resources = {
  en: {
    translation: {
      ...
      generalSettingsDescription: "Tweak the interface language and theme to fit your workspace.",
      languageSettingLabel: "Interface language",
      languageSettingHint: "Switch between English and Chinese instantly.",
      languageEnglish: "English",
      languageChinese: "中文",
      themeSettingLabel: "Theme mode",
      themeSettingHint: "Choose light, dark, or follow your OS preference.",
      aiSettingsDescription: "Decide which AI provider powers automation features.",
      collapse: "Collapse",
      expand: "Expand",
      provider: "Provider",
      baseUrl: "Base URL",
  ...
  zh: {
    translation: {
      ...
      generalSettingsDescription: "调整界面语言与主题偏好。",
      languageSettingLabel: "界面语言",
      languageSettingHint: "在中文与英文界面之间即时切换。",
      languageEnglish: "English",
      languageChinese: "中文",
      themeSettingLabel: "主题模式",
      themeSettingHint: "在浅色、深色或跟随系统之间切换。",
      aiSettingsDescription: "配置驱动自动化功能的 AI 服务。",
      collapse: "收起",
      expand: "展开",
      provider: "服务商",
